...
- `cognito_sub` (VARCHAR, UNIQUE): AWS Cognito user ID (links auth to employee)
- `employee_code` (VARCHAR, UNIQUE): Internal employee identifier
- `email_address` (VARCHAR): Email for login
