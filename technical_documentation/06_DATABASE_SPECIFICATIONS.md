...
## 6.1 Strategy Overview {#id-6.1-strategy-overview}
...
## 6.2 Key Data Patterns {#id-6.2-key-data-patterns}
...
## 6.3 Module Schemas {#id-6.3-module-schemas}
...
## 6.4 Shared Tables {#id-6.4-shared-tables}
